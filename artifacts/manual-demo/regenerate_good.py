...
# use the good seed
SEED_KEY="DEMO-V5-CONFORME-001-attempt-80"
# Actually we want a clean key tied to cheque number but with good properties; use attempt-80 which is deterministic and documented.
